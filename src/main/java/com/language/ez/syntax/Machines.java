...
public abstract class Machines {
    ...
    static {
                                                                       //             n    id   +    -    *    /    ^    %    <    >    <=  >=    ==   &&   ||    !   (    )    +=   -=   *=   /=   %=   |    $
        operatorPrecedence.put(Tokens.INTEGER,                         Arrays.asList(P.X, P.X, P.G, P.G, P.G, P.G, P.G, P.G, P.X, P.X, P.X, P.X, P.X, P.G, P.G, P.G, P.L, P.G, P.X, P.X, P.X, P.X, P.X, P.X, P.G));
        ...
        operatorPrecedence.put(Tokens.SWITCH_KEYWORD_EQUALITY_OPERATOR,Arrays.asList(P.L, P.L, P.L, P.L, P.L, P.L, P.L, P.L, P.X, P.X, P.X, P.X, P.X, P.G, P.G, P.G, P.L, P.G, P.X, P.X, P.X, P.X, P.X, P.L, P.G));
        operatorPrecedence.put(Tokens.AND_OPERATOR,                    Arrays.asList(P.X, P.L, P.X, P.X, P.X, P.X, P.X, P.X, P.L, P.L, P.L, P.L, P.L, P.G, P.G, P.L, P.L, P.G, P.X, P.X, P.X, P.X, P.X, P.L, P.G));
        operatorPrecedence.put(Tokens.OR_OPERATOR,                     Arrays.asList(P.X, P.L, P.X, P.X, P.X, P.X, P.X, P.X, P.L, P.L, P.L, P.L, P.L, P.L, P.G, P.L, P.L, P.G, P.X, P.X, P.X, P.X, P.X, P.L, P.G));
        operatorPrecedence.put(Tokens.NOT_OPERATOR,                    Arrays.asList(P.X, P.L, P.X, P.X, P.X, P.X, P.X, P.X, P.L, P.L, P.L, P.L, P.L, P.G, P.G, P.G, P.L, P.G, P.X, P.X, P.X, P.X, P.X, P.L, P.G));
        ...
        // expression transition table                 n      id    o    (     )     $     !      E     N     I     oc
        expressionTransition.put(Q.S0,  Arrays.asList(Q.S1, Q.S10, Q.X, Q.S4, Q.S0, Q.S0, Q.S11, Q.S13,Q.S1, Q.S0, Q.X));
        expressionTransition.put(Q.S1,  Arrays.asList(Q.X,  Q.X,   Q.S2,Q.X,  Q.R1, Q.R1, Q.X,   Q.X,  Q.X,  Q.X,  Q.X));
        expressionTransition.put(Q.S2,  Arrays.asList(Q.S1, Q.S1,  Q.X, Q.S4, Q.X, Q.X,  Q.S11, Q.S3, Q.S1,  Q.X,  Q.X));
        expressionTransition.put(Q.S3,  Arrays.asList(Q.X,  Q.X,   Q.R2,Q.X,  Q.X, Q.R2, Q.X,   Q.X,  Q.X,   Q.X,  Q.X));
        expressionTransition.put(Q.S4,  Arrays.asList(Q.S5, Q.S5,  Q.X, Q.S4, Q.X, Q.X,  Q.X,   Q.S8, Q.X,   Q.X,  Q.X));
        expressionTransition.put(Q.S5,  Arrays.asList(Q.X,  Q.X,   Q.S6,Q.X,  Q.R1,Q.X,  Q.X,   Q.X,  Q.X,   Q.X,  Q.X));
        expressionTransition.put(Q.S6,  Arrays.asList(Q.S5, Q.S5,  Q.X, Q.S4, Q.X, Q.X,  Q.S11, Q.S7, Q.S5,  Q.X,  Q.X));
        expressionTransition.put(Q.S7,  Arrays.asList(Q.X,  Q.X,   Q.X, Q.X,  Q.R2,Q.X,  Q.X,   Q.X,  Q.X,   Q.X,  Q.X));
        expressionTransition.put(Q.S8,  Arrays.asList(Q.X,  Q.X,   Q.S6,Q.X,  Q.S9,Q.X,  Q.X,   Q.X,  Q.X,   Q.X,  Q.X));
        expressionTransition.put(Q.S9,  Arrays.asList(Q.X,  Q.X,   Q.R3,Q.X,  Q.R3,Q.R3, Q.X,   Q.X,  Q.X,   Q.X,  Q.X));
        expressionTransition.put(Q.S10, Arrays.asList(Q.X,  Q.X,   Q.S2,Q.S0, Q.X, Q.R4, Q.X,   Q.X,  Q.X,   Q.X,  Q.S14));
        expressionTransition.put(Q.S11, Arrays.asList(Q.X,  Q.S12, Q.X, Q.X,  Q.X, Q.X,  Q.X,   Q.X,  Q.X,   Q.X,  Q.X));
        expressionTransition.put(Q.S12, Arrays.asList(Q.X,  Q.X,   Q.R5,Q.X,  Q.X, Q.R5, Q.X,   Q.X,  Q.X,   Q.X,  Q.X));
        expressionTransition.put(Q.S13, Arrays.asList(Q.S1, Q.S10, Q.S2,Q.X,  Q.S0,Q.S0, Q.X,   Q.X,  Q.X,   Q.X,  Q.X));
        expressionTransition.put(Q.S14, Arrays.asList(Q.X,  Q.X,   Q.X, Q.X,  Q.X, Q.R6, Q.X,   Q.X,  Q.X,   Q.X,  Q.X));

        // transition for primary statements        E     to   id    ,    as  typ    .      if   els  ind    pr     :    $     D      V     F    EF    P    [    ]    AE     A     AR  ct   frm   by    c
        primaryTransition.put(Q.S0,  Arrays.asList(Q.S1, Q.S0,Q.S0, Q.S0, Q.X, Q.S0, Q.S0,Q.S12,Q.S15,Q.S0, Q.S17,Q.S0, Q.S0, Q.X,  Q.S0, Q.S0, Q.S0,Q.S0,Q.S21,Q.S0, Q.X,  Q.S1, Q.X, Q.S40,Q.X, Q.X, Q.S0));
        ...
        primaryTransition.put(Q.S6,  Arrays.asList(Q.R2, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.R2, Q.R2, Q.R2, Q.R2, Q.X,  Q.R2, Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.R2, Q.X,  Q.X,  Q.X,  Q.X, Q.R2,Q.X, Q.X, Q.X));
        ...
        primaryTransition.put(Q.S9,  Arrays.asList(Q.R3, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.R3, Q.R3, Q.R3, Q.R3, Q.X,  Q.R3, Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.R3, Q.X,  Q.X,  Q.X,  Q.X, Q.R3,Q.X, Q.X, Q.X));
        ...
        primaryTransition.put(Q.S11, Arrays.asList(Q.R5, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.R5, Q.R5, Q.R5, Q.R5, Q.X,  Q.R5, Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.R5, Q.X,  Q.X,  Q.X,  Q.X, Q.R5, Q.X, Q.X, Q.X));
        ...
        primaryTransition.put(Q.S20, Arrays.asList(Q.R8, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.R8, Q.R8, Q.R8, Q.R8, Q.X,  Q.R8, Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.R8, Q.X,  Q.X,  Q.X,  Q.X, Q.R8,Q.X, Q.X, Q.X));
        primaryTransition.put(Q.S21, Arrays.asList(Q.S22,Q.X, Q.S22,Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.S23,Q.X,  Q.X, Q.X, Q.X, Q.X, Q.X));
        ...
        primaryTransition.put(Q.S26, Arrays.asList(Q.X,  Q.R11,Q.X,  Q.X,  Q.X, Q.X, Q.R11, Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X, Q.X));
        primaryTransition.put(Q.S27, Arrays.asList(Q.S28,Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X, Q.X));
        ...
        primaryTransition.put(Q.S29, Arrays.asList(Q.X,  Q.X,  Q.X,  Q.X,Q.R12, Q.X, Q.R12, Q.X,Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X, Q.X));
        primaryTransition.put(Q.S30, Arrays.asList(Q.X,  Q.X,  Q.X,  Q.X, Q.R13,Q.X, Q.R13, Q.X,Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X, Q.X));
        ...
        primaryTransition.put(Q.S32, Arrays.asList(Q.S33,Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X, Q.X));
        ...
        primaryTransition.put(Q.S34, Arrays.asList(Q.S35,Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X, Q.X));
        ...
        secondaryTransition.put(Q.S0,  Arrays.asList(Q.S0, Q.S29, Q.S1, Q.S6, Q.S9,Q.S11, Q.X,  Q.X,  Q.S0, Q.S13,Q.S13,Q.X, Q.X, Q.X, Q.X, Q.X, Q.X, Q.S0,Q.S0, Q.S26,Q.X, Q.S0,Q.X, Q.S0, Q.X, Q.X));
        ...
        secondaryTransition.put(Q.S12, Arrays.asList(Q.R4, Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.R4, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X, Q.X, Q.X, Q.R4,Q.R4, Q.R4, Q.X, Q.R4,Q.X, Q.R4, Q.X, Q.X));

        secondaryTransition.put(Q.S13, Arrays.asList(Q.X,  Q.S14, Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S14, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.S15,Q.X,  Q.X,  Q.S15,Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S15, Arrays.asList(Q.X,  Q.S16, Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.S31,Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X, Q.S19,Q.S22));
        secondaryTransition.put(Q.S16, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.S17,Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S17, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.S18,Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S18, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.R5, Q.X,  Q.X,  Q.R5, Q.R5,Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S19, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.R6, Q.X,  Q.X,  Q.R6, Q.S20,Q.X,Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X, Q.X,  Q.X));
        secondaryTransition.put(Q.S20, Arrays.asList(Q.X,  Q.S16, Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X, Q.S19,Q.S21));
        secondaryTransition.put(Q.S21, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.R7, Q.X,  Q.X,  Q.R7, Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S22, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.S25,Q.X,  Q.X,  Q.S23,Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S23, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.S24,Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S24, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.R8,Q.R8, Q.R8, Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S25, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.R9,Q.R9, Q.R9, Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S26, Arrays.asList(Q.S27,Q.S27, Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S27, Arrays.asList(Q.R11,Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.R11,Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.R11,Q.X,  Q.S28,Q.R11,Q.X, Q.X,Q.X, Q.X));
        secondaryTransition.put(Q.S28, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X,Q.R10,Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S29, Arrays.asList(Q.S30,Q.S30, Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S30, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.S10,Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S31, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.S32,Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X, Q.X,  Q.X,  Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
        secondaryTransition.put(Q.S32, Arrays.asList(Q.X,  Q.X,   Q.X,  Q.X,  Q.X, Q.X,   Q.X,  Q.X,  Q.X,  Q.X,  Q.X,  Q.X, Q.X,  Q.X,  Q.X,  Q.X,  Q.X,Q.R12,Q.R12,Q.R12,Q.X, Q.X, Q.X, Q.X,  Q.X, Q.X));
    ...
    public int getPrimaryColumn(Node node) {
        if (node.getLexeme() != null) {
            System.out.println("Primary Token: " + node.getLexeme().getToken());
            ...
            System.out.println("Primary Statement: " + node.getType());
            switch (node.getType()) {
    ...
    public int getSecondaryColumn(Node node) {
        if (node.getLexeme() != null) {
            System.out.println("Secondary Token: " + node.getLexeme().getToken());
            switch (node.getLexeme().getToken()) {
                case IDENTIFIER -> {
                    return 1;
                }
            ...
            System.out.println("Secondary Statement: " + node.getType());
            switch (node.getType()) {
    ...
    public Q getSecondaryTransition(Q state, Node node) {
        ...
        System.out.println("State: " + state + " Column: " + getSecondaryColumn(node));
